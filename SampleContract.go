...
func (t *SimpleChaincode) Invoke(stub *shim.ChaincodeStub, function string, args []string) ([]byte, error) {
	...
	} else if function == "delete_customer" {										//change owner of a marble
		return t.delete_customer(stub, args)
	}
...
// ============================================================================================================================
// Delete Customer - delete a customer from state 
// ============================================================================================================================
...
// ============================================================================================================================
// Update Customer - update a customer from state 
// ============================================================================================================================

func (t *SimpleChaincode) update_customer(stub *shim.ChaincodeStub, args []string) ([]byte, error) {
	var err error
	...
	fmt.Println("- start update of customer")
	if len(args[0]) <= 0 {
	...
	fmt.Println("- end update customer")
	return nil, nil													//send it onward
}
